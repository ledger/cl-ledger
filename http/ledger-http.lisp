...
(defpackage :ledger-http
  (:use :common-lisp :local-time :cambl :periods :ledger :series
	:hunchentoot :cl-who))
...
(defun string-if-not-empty (string)
  (if (not (string-emptyp string)) string))

(define-easy-handler (easy-demo :uri "/" :default-request-type :post)
  ...
  (with-html-output-to-string (*standard-output* nil :prologue t)
    (:html
     (:head (:title "Welcome to CL-Ledger"))
     (:body
